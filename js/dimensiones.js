var dimensiones = {
  ...
  alto: window.innertHeight || document.documentElement.clientHeight || document.body.clientHeight,
  ladoTiles: 100,
  escala: 1,
  iniciar: function () {
    window.addEventListener("resize", function (evento) {
      ...
      dimensiones.alto =  window.innertHeight || document.documentElement.clientHeight || document.body.clientHeight;
  ...
  obtenerTotalTiles: function () {
    return dimensiones.obtenerTilesVerticales * dimensiones.obtenerTilesHorizontales
  }
}
